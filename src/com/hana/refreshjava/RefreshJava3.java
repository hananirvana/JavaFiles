...
public class RefreshJava3 {
	public static void main(String[] args) {
		System.out.println("In this Refresh Java Program, we will play around with strings. \n ");
		...
		String str4 = str3.replace("11", srtNewAge);
		System.out.println("New String is =========>" + str4);
		System.out.println("Final String is =======>" + str4.replace("Bengaluru", "America"));
